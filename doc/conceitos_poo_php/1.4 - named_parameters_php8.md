# Nomeando parâmetros de métodos com php 8
A versão do php 8.0 é possível criar nomes para os atributos na hora de criar nosso método construtor veja o exemplo abaixo.
